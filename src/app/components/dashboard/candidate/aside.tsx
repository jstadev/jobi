...
import logout_icon from "@/assets/dashboard/images/icon/icon_9.svg";
...
const nav_data: { id: number; icon: StaticImageData; icon_active: StaticImageData; link: string; title: string }[] = [
  ...
  { id: 3, icon: nav_3, icon_active: nav_3_active, link: "/dashboard/candidate-dashboard/resume", title: "Resume" },
  { id: 4, icon: nav_4, icon_active: nav_4_active, link: "/dashboard/candidate-dashboard/messages", title: "Messages" },
  { id: 5, icon: nav_5, icon_active: nav_5_active, link: "/dashboard/candidate-dashboard/job-alert", title: "Job Alert" },
...
type IProps = { isOpenSidebar: boolean; setIsOpenSidebar: React.Dispatch<React.SetStateAction<boolean>> }
    ...
    <>
      <aside className={`dash-aside-navbar ${isOpenSidebar ? "show" : ""}`}>
        <div className="position-relative">
          ...
          <div className="user-data">
            <div className="user-avatar online position-relative rounded-circle">
              {profile?.avatar_url ? (
                ...
                <img src={profile.avatar_url} alt="avatar" style={{ width: 60, height: 60, borderRadius: "50%", objectFit: "cover" }} />
              ) : (
          ...
          <button onClick={logout} className="d-flex w-100 align-items-center logout-btn" style={{ background: "none", border: "none", cursor: "pointer" }}>
            <Image src={logout_icon} alt="icon" className="lazy-img" />
            <span>Logout</span>
          </button>
        </div>
      </aside>
